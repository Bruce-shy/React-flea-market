    ...
    <>
      <div className={styles.navWrap}>
        <Menu onClick={handleClick} style={{ width: 256 }} mode="vertical">
          <SubMenu key={SubType.Electronics} icon={<MailOutlined />} title="数码产品">
          ...
          <SubMenu key={SubType.BooksAndTextbooks} icon={<AppstoreOutlined />} title="书籍教材">
          ...
          <SubMenu key={SubType.Clothes} icon={<SettingOutlined />} title="衣帽鞋伞">
          ...
          <SubMenu key={SubType.TransportationTools} icon={<SettingOutlined />} title="代步工具">
          ...
          <SubMenu key={SubType.PhysicalFitness} icon={<SettingOutlined />} title="体育健身">
          ...
          <SubMenu key={SubType.HouseholdElectricAppliances} icon={<SettingOutlined />} title="家用电器">
            <Menu.Item key={NavType.Fan}>风扇</Menu.Item>
            <Menu.Item key={NavType.Audio}>音响</Menu.Item>
          </SubMenu>
          <SubMenu key={SubType.DailySupplies} icon={<SettingOutlined />} title="日常用品">
          ...
          <SubMenu key={SubType.VirtualProducts} icon={<SettingOutlined />} title="虚拟产品">
          ...
          <SubMenu key={SubType.MusicalInstruments} icon={<SettingOutlined />} title="乐器">
        ...
        <div className={styles.swiperWrap}></div>
      </div>
