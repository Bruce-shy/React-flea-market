...
export enum NavType {
  ...
  BalanceCar = '24', // 平衡车
  Skate = '25', // 滑板
  ElectricVehicle = '26', // 电动车
  Balls = '27', // 球类
  Racket = '28', // 球拍
  GymShoes = '29', // 运动鞋
  SportsEquipment = '30', // 运动装备
  FitnessEquipment = '31', // 健身器材
  Fan = '32', // 风扇
  Audio = '33', // 音响
  MakeupAndSkinCare = '34', // 化妆护肤
  Gadget = '35', // 小工具
  SchoolSupplies = '36', // 学习用品
  AroundTheGame = '37', // 游戏周边
  RechargeableCard = '38', // 充值卡
  VariousAccount = '39', // 各类账号
  Guitar = '40', // 吉他
  Piano = '41', // 钢琴
  Yukri = '42', // 尤克里里
  ElectronicOrgan = '43', // 电子琴
  Harmonica = '44', // 口琴/竖笛
  PercussionInstruments = '45', // 打击乐器
  Other = '46', // 其他
}
